...
class _ExploreApiService implements ExploreApiService {
  ...
  Future<AllDoctorsResponseModel> getAllDoctors() async {
    ...
    final _options = _setStreamType<AllDoctorsResponseModel>(
  ...
  @override
  Future<AllDoctorsResponseModel> searchDoctors(String name) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<AllDoctorsResponseModel> filterDoctors(int specializationId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
